  ...
  if (onClick) {
    return (
      <button
        ...
        onClick={onClick}
        className={`flex group w-full relative items-center justify-start mt-[0.75em] border border-transparent hover:bg-brand-200 hover:bg-opacity-70 p-1 rounded hover:text-brand-500 text-brand-400 ${getWrapperStyles()}`}
      >
        <NavItemInner
          icon={icon}
